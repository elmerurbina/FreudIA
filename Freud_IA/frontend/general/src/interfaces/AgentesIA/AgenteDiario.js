  ...
  const handleSendMessage = () => {
    if (input.trim() !== '') {
      ...
      setTimeout(() => {
        setMessages((prevMessages) => [
          ...prevMessages,
          { type: 'bot', text: 'Hi! Soy el Agente especialista en ayudarte con tu diario personal' }
        ]);
      }, 500);
    }
  };
    ...
    <div className="agente-ia">
      ...
      <div className="chat-container">
        <div className="welcome-message bot-message">
          ...
          <span>Bienvenido/a, Soy el agente especialista en ayudarte con tu diario personal!</span>
        </div>
        ...
        <div className="input-container">
          ...
          <textarea
            placeholder="Soy el Agente especialista en ayudarte con tu diario personal, escribe tu mensaje"
            value={input}
