    ...
    <View style={styles.dashboard}>
      <View style={styles.videoSection}>
        <Video
          ...
          muted
          repeat
          controls // This prop might depend on the Video component you use
        />
      </View>
...
const styles = StyleSheet.create({
  dashboard: {
    flex: 1,
    backgroundColor: 'linear-gradient(135deg, rgba(65, 32, 137, 1), rgba(47, 23, 99, 1))', // Gradients need additional libraries
    color: 'white',
    padding: 10,
    paddingTop: 10,
  },
  ...
  text: {
    fontSize: 16,
    lineHeight: 24,
    marginLeft: '10%', // 25% margin for left and right
    marginRight: '10%',
    color: 'white', // Text color
  },
  videoSection: {
