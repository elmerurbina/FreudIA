  ...
  const handleSendMessage = () => {
    if (input.trim() !== '') {
      ...
      setTimeout(() => {
        setMessages((prevMessages) => [
          ...prevMessages,
          { type: 'bot', text: 'Hi! Necesitas motivacion? Dime que es lo que mas te preocupa?' }
        ]);
      }, 500);
    }
  };
    ...
    <div className="agente-ia">
      <div className="user-profile-container">
        ...
        <div className="welcome-message bot-message">
          <img
              src={require('../../assets/images/Marina.jpeg')}
              alt="Welcome Icon"
        ...
        <div className="input-container">
          ...
          <textarea
            placeholder="Necesitas motivacion? Dime que es lo que mas te preocupa?"
            value={input}
